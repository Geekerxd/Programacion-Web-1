 ...
 * @author Dell 66895
 */
@WebServlet(name = "FavComentaryController", urlPatterns = {"/FavComentaryController"})
public class FavComentaryController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       NoticiaDAO.FavNoti(Integer.parseInt(idusu,10),Integer.parseInt(idNew,10));
