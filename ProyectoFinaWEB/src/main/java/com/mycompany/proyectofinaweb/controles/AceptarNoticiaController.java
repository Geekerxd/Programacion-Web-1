 ...
 * @author Dell 66895
 */
@WebServlet(name = "AceptarNoticiaController", urlPatterns = {"/AceptarNoticiaController"})
public class AceptarNoticiaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        NoticiaDAO.AceptaNew(Integer.parseInt(idNews,10)); 
