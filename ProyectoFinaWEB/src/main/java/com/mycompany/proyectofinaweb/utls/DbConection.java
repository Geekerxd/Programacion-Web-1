...
public class DbConection {
    ...
    static {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/db_proyect_pw1?useUnicode=true&useJDBCCompliantTimeZoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
