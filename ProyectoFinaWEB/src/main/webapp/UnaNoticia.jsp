    ...
    <body> 
        ...
        <div class="container">
            ...
            <div class="row A-left"style="margin-top: 20px; margin-left: 10px">
                ...
                <i class="fas fa-comment" :hover><%= contador%></i>
                ...
                <div class="dropdown">
                    ...
                    <%if (session.getAttribute("ELidusuarios") != null) {%>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">


                        
                        <a class="dropdown-item" href="FavComentaryController?idusu=<%= session.getAttribute("ELidusuarios") %>&idNew=<%=element.getId()%>">Aderir a noticias favoritas</a>
                    </div>
                    <% }%>
            ...
            <% } else {
            %>
            <form  method = "POST" action = "ComentarioAnonimo" class ="Comments" style="margin-top: 20px">

                <label for="fname">Comentar:</label>
                <br>
                <input placeholder="Escribe tu nombre anonimo" type="text" name="nameAnonimo" style="width: 300px">
                <textarea type="text" id="fname" name="fname" placeholder="Escribe un comentario"></textarea>
                <input type="hidden" name="idNew" value="<%= element.getId()%>">
            ...
            <div style="display:block;  margin-bottom: 30px"> <!--  un comentario -->
                <div class="media"> 
                    <!-- foto -->
                    <% if ((int) comment.getIdanonimo() == -1 || comment.getIdusuario() != -1) {%>
                    <img class="icon-link align-self-start mr-3" src="<%=comment.getElUsuario().getFoto()%>" alt="..." >

                    <% } else {%>
                    <img class="icon-link align-self-start mr-3" src="Assets/anonimo.jpg" alt="..." >
                    <% }%>
                    ...
                    <div class="media-body">
                        <div class="row2">
                            ...
                            <% if ((int) comment.getIdanonimo() == -1 || comment.getIdusuario() != -1) {%>
                            <h5 class="mt-0" style="margin-right: 5px"><%=comment.getElUsuario().getNombre()%> <%=comment.getElUsuario().getApellidos()%> </h5>
                            <% } else {%>
                            <h5 class="mt-0"><%= comment.getIdanonimo()%> </h5>
                            ...
                            <em style=" color: #F29849; font-size: 20px ">  <small> (admin) </small></em>
                            <%
                            ...
                            <em style=" color: #F29849; font-size: 20px ">  <small> (registrado) </small></em>
                            <%
                            ...
                            <em style=" color: #F29849; font-size: 20px ">  <small> (moderador) </small></em>
                            <%
                            ...
                            <em style=" color: #F29849; font-size: 20px ">  <small> (editor) </small></em>
                            <%
                            ...
                            <em style=" color: #F29849; font-size: 20px ">  <small> (creador de contenido) </small></em>
                            <%
                            } else {
                            %>
                            <small> (Usuario Anonimo) </small>
                ...
                <div class="media" style="margin-left: 85px;">
                    ...
                    <div class="dropdown">
                        ...
                        <%
    if ((int) session.getAttribute("ELtipousu") == 1 || (int) session.getAttribute("ELtipousu") == 3) {//es admin
%>
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
